...
# and any custom modules under embedded_linux_drivers/modules. After a
# successful build, module *.ko files can be located in the module's source
# folder. See run.sh for more info on how to transfer the *.ko files to the
# BBB.
